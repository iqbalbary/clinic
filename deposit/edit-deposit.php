...
<div class="container">
    <form action="" method='post' enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="Number" required="required" class="form-control" value="<?= $depositDetailsData['Amount'] ?>" required="true" name="Amount" placeholder="5000">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea type="textarea" class="md-textarea form-control" required="true" name="Short_Description" placeholder="Short Description" rows="10">
