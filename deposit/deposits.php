        ...
        <div class="col-sm-12">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td> <a href="<?=$base_url;?>user/view-user.php?id=<?=$data['submission_id']?>">
                                <?=@$userDataMap[$data['submission_id']]['Name'];?> <span> at
                                    <?=date("Y- m -d ", $data['Date'])?></span> </a> </td>
                        <td>
                            <?php
...
?>
                        ...
                        <td> <?php if ($data['Deposite_Slip']) {?> <img
                                src="<?=$base_url . "uploads/Deposite/Deposite_Slip/" . $data['Deposite_Slip'];?>"
                                alt="slipimage"> <?php }?> </td>
                        <td>
    ...
    ?>
                            ...
                            <span> <a
                                    href="<?=$base_url?>deposit/edit-deposit.php?deposit-id=<?=$data['Deposite_ID']?>">
                                    Edit
                                </a> </span>
                            <?php }
}?>
